...
public abstract class SecondaryHosDiagnoseListAdapter<GVH, SVH extends RecyclerView.ViewHolder> extends RecyclerView
        .Adapter<RecyclerView.ViewHolder> {

    private List<Boolean> groupItemStatus = new ArrayList<>();

    private ArrayList<HosDiagnosisBean> dataTrees = new ArrayList<>();
     ...
     *
     */
    public void notifyNewData(ArrayList<HosDiagnosisBean> data,String type) {
     ...
     *
     */
    private final void setDataTrees(ArrayList<HosDiagnosisBean> dt,String type) {
        if(type.equals("2")){
            this.dataTrees = dt;
    ...
    public final void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        final HosDiagnosisBean dt = dataTrees.get(itemStatus.getGroupItemIndex());
