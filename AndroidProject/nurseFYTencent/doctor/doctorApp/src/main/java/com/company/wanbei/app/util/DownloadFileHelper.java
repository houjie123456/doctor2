...
public class DownloadFileHelper {
    ...
    public DownloadFileHelper(Context mContext, Handler handler) {
    ...
    public void downFile(final String path) {
        ...
        Bitmap btm = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.img_icon);//可以换成你的app的logo
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            //设置通知显示图标、文字等
            builder.setSmallIcon(R.drawable.img_icon)//可以换成你的app的logo
                    .setLargeIcon(btm)
                    .setTicker("正在下载")
