 ...
 */
public class DatePickDialog1 extends Dialog implements OnChangeLisener {
    ...
    private DatePicker1 mDatePicker1;
    ...
    public DatePickDialog1(Context context) {
    ...
    private DatePicker1 getDatePicker() {
        DatePicker1 picker = new DatePicker1(getContext(), type);
    ...
    private void initView() {
        ...
        this.wheelLayout.addView(mDatePicker1);
        ...
        this.sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onSureLisener != null) {
                    onSureLisener.onSure(mDatePicker1.getSelectDate());
                }
            }
        });
    }
