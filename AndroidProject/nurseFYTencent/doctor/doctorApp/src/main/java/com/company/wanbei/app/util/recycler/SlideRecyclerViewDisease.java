...
public class SlideRecyclerViewDisease extends RecyclerView {
    ...
    public SlideRecyclerViewDisease(Context context) {
        this(context, null);
    }

    public SlideRecyclerViewDisease(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideRecyclerViewDisease(Context context, @Nullable AttributeSet attrs, int defStyle) {
