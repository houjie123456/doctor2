	...
	public static String sortMapByKey(Map<String, String> map) {
		...
		for(int i = 0; i<key.length; i++) {
			if (map.get(key[i])!=null) {
				newParam += map.get(key[i]);
			}
		}
		Log.i("sortMapByKey2",newParam);
 		return newParam;
	}
	public static String sortMapByKey22(Map<String, Object> map) {
		Object[] key =  map.keySet().toArray();
		Arrays.sort(key);
		String newParam="";
		for(int i = 0; i<key.length; i++) {
...
//		sign = Encrytion.MD5(sortMapByKey2(map)+C.KEY);
		...
		char[] array = (sortMapByKey(map)+ C.KEY2).toCharArray();
		Arrays.sort(array);
		String arrayString = String.valueOf(array).replace(" ", "");
		sign=md5(arrayString);
		Log.i("getSign",sign);
		return sign;
	}
	public static String getSign222(Map<String, Object> map,String strRand,String strTime){
		String sign = "";
		if (map.size() <0) return sign;
//		sign = Encrytion.MD5(sortMapByKey2(map)+C.KEY);


		String s =sortMapByKey22(map) + strRand + strTime + C.KEY3;
		char[] array = (sortMapByKey22(map) + strRand + strTime + C.KEY3).toCharArray();
	...
	public static String getSign22(Map<String, Object> map){
		String sign = "";
		if (map.size() <0) return sign;
//		sign = Encrytion.MD5(sortMapByKey2(map)+C.KEY);
		...
		char[] array = (sortMapByKey22(map) + C.KEY2).toCharArray();
	...
	public static String getSign(Map<String, String> map){
		...
		if (map.size() <=0) return sign;
		sign = Encrytion.MD5(sortMapByKey2(map)+ C.KEY);
//		char[] array = (sortMapByKey2(map)+C.KEY).toCharArray();
//		Arrays.sort(array);
