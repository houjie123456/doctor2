...
//        String type = getCustomType(v2TIMMessage);
//        if(type.equals("")){
//
//        }
    ...
    private static String getCustomType(V2TIMMessage v2TIMMessage) {
        byte[] customData = v2TIMMessage.getCustomElem().getData();
        String data = new String(customData);
        ...
        Object typeObj = null;
        if (customJsonMap != null) {
            typeObj = customJsonMap.get(TUIConstants.Message.CUSTOM_TYPE_ID_KEY);
        }
    ...
    public static String getReplyMessageAbstract(TUIMessageBean messageBean) {
        ...
        if (messageBean != null) {
            ...
            } else if (messageBean instanceof CustomFirstAskMessageBean) {
//                extra = ((CustomFirstAskMessageBean) messageBean).getText();
                extra = "有新的患者咨询";
