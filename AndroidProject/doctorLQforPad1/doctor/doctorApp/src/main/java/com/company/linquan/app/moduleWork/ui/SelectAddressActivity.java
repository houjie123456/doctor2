...
public class SelectAddressActivity extends BaseActivity implements WorkInterface.SelectAddressInterface{
    private Dialog myDialog;

    private RecyclerView recordRecycler;
    private ArrayList<AddressBean> array;
    private RecordListAdapter adapter;
    private SwipeRefreshLayout refreshLayout;
    int sw;
    private final static int ADD = 1;
    private SelectAddressPresenterImp presenter;
    private int page = 1;
    private String ids = "";
    private int index = 0;
    ...
    private void initView(){
        presenter = new SelectAddressPresenterImp(this);
    ...
    private void setListener() {
        adapter.setOnItemClickListener(new OnItemClick() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent();
                intent.putExtra("lat",array.get(position).getLatitude());
                intent.putExtra("lon",array.get(position).getLongitude());
                intent.putExtra("address",array.get(position).getDetailAddress());
                intent.putExtra("room",array.get(position).getRoomNo());
    ...
    private class RecordListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecordListAdapter(Context context,ArrayList<AddressBean> list ){
        ...
        private void initView(RecordViewHolder handler, AddressBean bean){
            if (bean == null) return;
            handler.titleTV.setText(bean.getDetailAddress());
            handler.contentTV.setText(bean.getRoomNo());
        }
    }
    ...
    @Override
    public void reloadList(ArrayList<AddressBean> list) {
