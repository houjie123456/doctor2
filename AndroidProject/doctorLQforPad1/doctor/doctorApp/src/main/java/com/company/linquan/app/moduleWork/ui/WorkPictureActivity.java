...
import com.company.linquan.app.moduleWork.imp.PicturePresenterImp;
...
public class WorkPictureActivity extends BaseActivity implements WorkInterface.PictureInterface,View.OnClickListener{
    private Dialog myDialog;

    private RecyclerView  recordRecycler;
    private SwipeRefreshLayout refreshLayout;
    private ArrayList<PictureFaceBean> array = new ArrayList<>();
    ...
    private void initView(){
        ...
        refreshLayout = (SwipeRefreshLayout)findViewById(R.id.work_picture_refresh);
        refreshLayout.setColorSchemeColors(ContextCompat.getColor(this,R.color.base_red_color));

        recordRecycler = (RecyclerView)findViewById(R.id.work_picture_recycler);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.work_picture_mid_layout:
                startActivity(new Intent(this, SettingPictureActivity.class));
                break;
        }
    }
    ...
    public RecordListAdapter(Context context,ArrayList<PictureFaceBean> list ){
        this.mContext = context;
        this.mList = list;
    }


    public void setList(ArrayList<PictureFaceBean> list){
        this.mList = list;
    ...
    private void initView(RecordViewHolder handler, PictureFaceBean bean){
...
private static class RecordViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    @Override
    public void reloadPicture(ArrayList<PictureFaceBean> list) {
