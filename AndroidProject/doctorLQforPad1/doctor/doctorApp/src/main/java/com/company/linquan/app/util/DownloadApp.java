...
import com.company.linquan.app.moduleHome.HomeInterface;
...
//			mDownloadDialog.dismiss();
	...
	private void installApk(){
		...
		if (Build.VERSION.SDK_INT >= 24) {
			...
			Uri apkUri = FileProvider.getUriForFile(mContext,"com.company.linquan.app.fileProvider", apkfile);//通过FileProvider创建一个content类型的Uri
