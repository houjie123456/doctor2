...
public class CreateOrderFaceActivity extends BaseActivity  implements WorkInterface.CreateOrderFaceInterface, View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.create_order_face_btn:
                finish();
                break;
        }
    }
