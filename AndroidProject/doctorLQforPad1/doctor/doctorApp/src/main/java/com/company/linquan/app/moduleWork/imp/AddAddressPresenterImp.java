...
public class AddAddressPresenterImp implements WorkInterface.AddAddressPresenterInterface {

    private WorkInterface.AddAddressInterface view;

    public AddAddressPresenterImp(WorkInterface.AddAddressInterface view) {
        this.view = view;
    }
