 ...
 */
    ...
    synchronized List<JSONObject> getJsonObjects(String JsonString) {
        JsonString = getJsonStrFromNetData(JsonString);
 ...
 */
    ...
    synchronized String getJsonStrFromNetData(String jsonString) {
     ...
     * @param classOfT 实体的类型
     * @return 实体数组
     */
//    public static synchronized <T> void getEntityFromJson(String jsonStr, Class<T> classOfT) {
//        try {
