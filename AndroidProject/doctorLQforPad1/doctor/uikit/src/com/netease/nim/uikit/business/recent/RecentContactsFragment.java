 ...
 */
public class RecentContactsFragment extends TFragment implements View.OnClickListener,PopupMenu.OnMenuItemClickListener {
    ...
    private void findViews() {
        ...
        title.setText("消息");
        TextView menu = (TextView) head.findViewById(R.id.head_top_right_menu);
        menu.setText(". . .");
        menu.setOnClickListener(this);
        TextView title2 = (TextView) head.findViewById(R.id.head_top_left);
        title2.setText("联系人");
    ...
    public void onClick(View v) {
        if (v.getId()== com.netease.nim.uikit.R.id.head_top_left){
            ...
            fragment.setContainerId(com.netease.nim.uikit.R.id.contact_fragment);
...
//                    .beginTransaction()
//                    .replace(com.netease.nim.uikit.R.id.contact_fragment, new ContactsFragment(), null)
//                    .addToBackStack(null)
//                    .commit();
        }
        //创建弹出式菜单对象（最低版本11）
